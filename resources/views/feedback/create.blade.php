        ...
        <div class="row">
            ...
            <div class="col-lg-10 mx-auto mb-3 p-5 rounded bg-white border border-light shadow-sm">
                ...
                <form action="{{route('feedbacks.store')}}" method="post">
                    ...
                    <div class="row mb-3 align-items-end">
                        <label for="inputName" class="col-sm-3 col-form-label fs-4">{{__('appword.title')}}:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3 align-items-end" title="{{__('appword.Write your review or a question')}}">
                        <label for="desc" class="col-sm-3 col-form-label fs-4" >{{__('appword.message')}}:</label>
                        <div class="col-sm-9">
                    ...
                    <div class="row mb-3 justify-content-center">
                        <div class="col-md-4">
                            <button class="btn btn-outline-success mt-4 w-100 text-uppercase">{{__('appword.send')}}</button>
                        </div>
                    </div>
            ...
            <div class="col-lg-10 mx-auto justify-content-between d-flex mt-2 fs-4">
                <div class="mb-3">
                    ...
                    {{__('appword.Our Phone')}}: 8 777 777 77 77
                </div>
                <div class="mb-3">
                    ...
                    {{__('appword.email adr')}}: itlib@gmail.com
                </div>
